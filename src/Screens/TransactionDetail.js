...
export default class TransactionDetail extends Component {
  ...
  render() {
    const image = {
      uri: "https://play-lh.googleusercontent.com/2u7cigMgoBJhULx9ZXmtdZV2RdFklF2Uef3GNuIUI2QlYJdWkSnPfzFdhWlGC8IZ1tM",
    };
    ...
    return (
      <>
        <View style={{ flex: 1, backgroundColor: "#07cdce" }}>
          ...
          >
            <Text Style={{ fontSize: 18, fontWeight: "bold" }}>Refound</Text>
          ...
          <View style={styles.content}>
            <View style={styles.SubHeader}>
              ...
              >
                <TouchableRipple
                  rippleColor="rgba(205, 205, 205, 0.4)"
                  borderless={true}
                  onPress={() => console.log("h")}
                  style={styles.share}
                >
                  <IconE name="share" size={30} color="#07cdce" />
                </TouchableRipple>
              </View>
            </View>
